...
export type JahrReportResponse = Schemas["JahrReportResponse"];
export type YearListResponse = Schemas["YearListResponse"];
export type JahrGruppe = Schemas["GruppeOut"];
export type JahrPosition = Schemas["KontoPosition"];
export type Abschreibung = Schemas["AbschreibungOut"];
