/** Keyboard model of the review list (B-14): j/k move, a/r decide. Pure, unit-tested. */
export type ReviewKey = "next" | "prev" | "approve" | "reject";

export function reviewKeyFor(e: { key: string; metaKey: boolean; ctrlKey: boolean; altKey: boolean; shiftKey: boolean }): ReviewKey | null {
