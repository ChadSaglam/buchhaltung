...
from app.schemas.review import ReviewActionResponse, ReviewItemOut, ReviewQueueResponse
...
def _serialize(item) -> ReviewItemOut:
...
async def list_pending(
    ...
    return ReviewQueueResponse(threshold=threshold, count=len(items), items=[_serialize(i) for i in items])
